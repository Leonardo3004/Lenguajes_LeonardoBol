...
func masParecido(lista [5]persona, muestra [10]byte) int {
	...
	imprimirPersonaArray(masparecido, lista)
	return masparecido
}
...
func masParecido4(lista []persona, muestra []byte) int {
	...
	imprimirPersonaSlice(masparecido, lista)
	return masparecido
}

func imprimirPersonaArray(i int, mostrar [5]persona) {
	fmt.Println("--->Persona #2 ARRAY (Tarea): ", mostrar[i].nombre, mostrar[i].apellido)
}

func imprimirPersonaSlice(i int, mostrar []persona) {
	fmt.Println("--->Persona #2 Slice (Tarea): ", mostrar[i].nombre, mostrar[i].apellido)
}
...
func main() {
	...
	//invocacion de la tarea
	imprimirPersonaSlice(0, lista_personas_slice)
